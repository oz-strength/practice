...
const newNubers = numbers3.map(num => num * 2);
...
const newNumbers4 = numbers4.filter(x => x % 2 === 0);
...
// book의 title을 출력한다
// book의 author를 출력한다
const book = { title: "책제목", author: "작가명" };
console.log(book);
...
const person = { name: "김철수", age: 25, job: "학생" };
console.log(person);
...
const product = { name: "컴퓨터", price: 100 };
product["price"] = 120;
console.log(product);
product["brand"] = "삼성";
console.log(product);
...
const person2 = { name: "이민수", age: 35, city: "부산" };
...
const student11 = { name: "학생", grades: ["A", "B", "C"] };

console.log(student11);
student11.grades.push("D");
console.log(student11);
/* 출력 결과
...
console.log(memoList.filter(e=>e.isDone===false))
/*
{ content: "오늘 할 일", isDone: false }
{ content: "오늘 할 일 3", isDone: false }
*/
...
console.log(userList.filter(e=>e.age %2 ===0).map(e=>e.name))
/* 출력 결과
김철수
장영실
*/
